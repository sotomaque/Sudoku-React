...
const Tools = ({ solve, solveEnabled, newGame, loadGame, loadEnabled, showCandidates,
  ...
  return (
    <div className="tools">
      <div className="buttons">
        ...
        <button className="button is-primary" onClick={showCandidates}> Show Possible Values </button>
      </div>
    </div>
  );
};
